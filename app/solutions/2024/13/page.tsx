...
const renderInfoText = () => {
  return (<>
    Since the offset value for part 2 can&apos;t be determined from the input, the result may differ from expected.
    This solution uses an offset of
    <b><code className="text-black dark:text-white">&nbsp;10000000000000&nbsp;</code></b>
    for part 2.
  </>);
};